...
const pdf = React.createElement(Document, { title: "Julianna Roberts \u2014 Resume", author: "Julianna Roberts" },
  React.createElement(Page, { size: "LETTER", style: s.page },
    ...
    React.createElement(View, { style: s.section },
      ...
      ...[
        { role: "AI and Design Engineer Intern", org: "Renoverse AI", dates: "May 2026", desc: "Owned an end-to-end website revamp for an AI renovation/home-construction startup, replacing a no-code Squarespace landing page with a hand-built, responsive site \u2014 designed Figma mockups and interactive prototypes, translated designs into production HTML using Paper with Claude, established a reusable design system via Google's design.md protocol, and shipped a live site in ~24 hours after re-strategizing to hit the client's end goal; authored a team handoff guide for editing and scaling the site with Claude going forward" },
      ...
      React.createElement(View, { style: s.recognitionColumns },
        React.createElement(View, { style: s.recognitionColumn },
          ...
          ...[
            ...
            ["Anderson Presidential Scholarship", "2022 \u2014 2025"],
